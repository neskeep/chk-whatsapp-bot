...
"""
Prueba tu agente CHK sin necesitar WhatsApp.
...
async def main():
    ...
    print()
    print("=" * 55)
    print("   CHK Asistente — Test Local")
    print("=" * 55)
    print()
    print("  Escribe mensajes como si fueras un cliente de CHK.")
